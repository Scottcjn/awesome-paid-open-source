...
- [Dnote](https://github.com/dnote/dnote) (AGPLv3) is free to self-host or use locally, but [offers a paid, hosted version](https://dnote.io/pricing) for the server side software.
